    ...
    <div class="user-admin">
        <b-form>
            ...
            <b-row v-show="mode === 'save'"> 
                <b-col md="6" sm="12" class="mt-2 mb-2">
                    <b-form-checkbox id="user-admin" v-model="user.admin">Administrador?</b-form-checkbox>
                </b-col>
            </b-row>
...
export default {
    ...
    methods: {
        ...
        loadUser(user, mode = 'save') {
            this.mode = mode
            this.user = { ...user } // selecionando/clonando objeto passado como parametro com operador spread do JS "..." para var global de user!
        }
    },
    mounted() {
        this.loadUsers()
